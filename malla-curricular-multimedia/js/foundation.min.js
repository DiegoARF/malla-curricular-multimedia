  ...
  t.Foundation = {
    ...
    utils: {
      ...
      data_options: function (t, n) {
        ...
        f(s[1]) && (s[1].indexOf('.') === - 1 ? s[1] = parseInt(s[1], 10)  : s[1] = parseFloat(s[1])),
  ...
  Foundation.libs.alert = {
    ...
    events: function () {
      ...
      e(this.scope) .off('.alert') .on('click.fndtn.alert', '[' + this.attr_name() + '] .close', function (e) {
        ...
        e.preventDefault(),
        Modernizr.csstransitions ? (r.addClass('alert-close'), r.on('transitionend webkitTransitionEnd oTransitionEnd', function (e) {
          n(this) .trigger('close') .trigger('close.fndtn.alert') .remove(),
          i.callback()
...
function (e, t, n, r) {
  ...
  Foundation.libs.clearing = {
    ...
    init: function (e, t, n) {
      ...
      this.bindings(t, n),
      r.S(this.scope) .is('[' + this.attr_name() + ']') ? this.assemble(r.S('li', this.scope))  : r.S('[' + this.attr_name() + ']', this.scope) .each(function () {
    ...
    events: function (r) {
      ...
      s(this.scope) .off('.clearing') .on('click.fndtn.clearing', 'ul[' + this.attr_name() + '] li ' + this.settings.open_selectors, function (e, t, n) {
        var t = t || s(this),
        n = n || t,
        r = t.next('li'),
    ...
    swipe_events: function (e) {
      ...
      n(this.scope) .on('touchstart.fndtn.clearing', '.visible-img', function (e) {
        ...
        n(this) .data('swipe-transition', t),
        e.stopPropagation()
        ...
        Foundation.rtl && (r.delta_x = - r.delta_x),
        typeof r.is_scrolling == 'undefined' && (r.is_scrolling = !!(r.is_scrolling || Math.abs(r.delta_x) < Math.abs(e.touches[0].pageY - r.start_page_y)));
    ...
    assemble: function (t) {
      ...
      Modernizr.touch && (a = e(a) .find('.clearing-touch-label') .html(f) .end()),
      s.after(a) .remove()
    },
    open: function (t, r, i) {
      function p() {
      ...
      function d(t) {
        ...
        f.show(),
        this.fix_height(i) .caption(s.S('.clearing-caption', f), s.S('img', i)) .center_and_label(t, c) .shift(r, i, function () {
          i.closest('li') .siblings() .removeClass('visible'),
          i.closest('li') .addClass('visible')
        }),
    ...
    close: function (t, r) {
      ...
      o,
      u;
      return r === t.target && i && (s.css('overflow', ''), o = e('div', i) .first(), u = e('.visible-img', o), u.trigger('close.fndtn.clearing'), this.settings.prev_index = 0, e('ul[' + this.attr_name() + ']', i) .attr('style', '') .closest('.clearing-blackout') .removeClass('clearing-blackout'), o.removeClass('clearing-container'), u.hide(), u.trigger('closed.fndtn.clearing')),
    ...
    keydown: function (t) {
      ...
      t.which === s && this.S('a.clearing-close') .trigger('click') .trigger('click.fndtn.clearing')
    },
    nav: function (t, n) {
    ...
    load: function (e) {
      var t;
      return e[0].nodeName === 'A' ? t = e.attr('href')  : t = e.parent() .attr('href'),
      this.preload(e),
      t ? t : e.attr('src')
    },
    preload: function (e) {
    ...
    go: function (e, t) {
      ...
      r = n[t]();
      this.settings.skip_selector && r.find(this.settings.skip_selector) .length != 0 && (r = r[t]()),
      r.length && this.S('img', r) .trigger('click', [
        n,
        r
    ...
    shift: function (e, t, n) {
      ...
      t.index() !== i && !/skip/.test(s) ? /left/.test(s) ? (this.lock(), l[o] = u + a, r.animate(l, 300, this.unlock()))  : /right/.test(s) && (this.lock(), l[o] = u - a, r.animate(l, 300, this.unlock()))  : /skip/.test(s) && (f = t.index() - this.settings.up_count, this.lock(), f > 0 ? (l[o] = - (f * a), r.animate(l, 300, this.unlock()))  : (l[o] = 0, r.animate(l, 300, this.unlock()))),
      n()
    },
    direction: function (e, t, n) {
      ...
      o = r.index(n),
      u;
      return this.settings.up_count = s,
      this.adjacent(this.settings.prev_index, o) ? o > s && o > this.settings.prev_index ? u = 'right' : o > s - 1 && o <= this.settings.prev_index ? u = 'left' : u = !1 : u = 'skip',
    ...
    show: function (n, r) {
      if (r) {
        ...
        if (a.pop) {
          ...
          var f = {
            top: e(t) .scrollTop() + n.data('css-top') -40+ 'px', // modifico le top del reveal
            opacity: 1
          };
        ...
        if (o.pop) {
          ...
          return setTimeout(function () {
            return n.animate(u, s.animation_speed, 'linear', function () {
              this.locked = !1,
              n.css(r) .trigger('closed') .trigger('closed.fndtn.reveal')
...
function (e, t, n, r) {
  ...
  Foundation.libs.tooltip = {
    ...
    selector: function (e) {
      ...
      return (t && t.length < 1 || !t) && typeof n != 'string' && (n = this.random_str(6), e.attr('data-selector', n) .attr('aria-describedby', n)),
      t && t.length > 0 ? t : n
    },
    create: function (n) {
      var r = this,
    ...
    hide: function (e) {
      ...
      t.fadeOut(150, function () {
        ...
        t.off('click.fndtn.tooltip.tapclose MSPointerDown.fndtn.tapclose'),
        e.removeClass('open')
      })
    },
    off: function () {
